    ...
    <div className="max-w-5xl mx-auto space-y-6 pb-10">
      <Card className="rounded-3xl border-slate-200 shadow-sm bg-white">
        ...
        <CardContent className="space-y-6">
          <div>
            <h3 className="text-base font-semibold mb-3">{tr("chGettingStarted")}</h3>
          ...
          <div>
            <h3 className="text-base font-semibold mb-3">{tr("chFindingJobs")}</h3>
            <ul className="list-disc pl-6 text-sm text-slate-600 space-y-2">
          ...
          <div>
            <h3 className="text-base font-semibold mb-3">{tr("chAppStatus")}</h3>
            <ul className="list-disc pl-6 text-sm text-slate-600 space-y-2">
              <li><strong>{tr("statusSubmitted")}:</strong> Your application was received</li>
              <li><strong>{tr("statusReviewed")}:</strong> Recruiter reviewed your application</li>
              <li><strong>{tr("statusShortlisted")}:</strong> You passed the initial screening</li>
              <li><strong>{tr("statusInterview")}:</strong> Invited to interview round</li>
              <li><strong>{tr("statusOffered")}:</strong> Job offer received</li>
              <li><strong>{tr("statusRejected")}:</strong> Not selected for this role</li>
            </ul>
          </div>

          <div>
            <h3 className="text-base font-semibold mb-3">{tr("chImproving")}</h3>
            <ul className="list-disc pl-6 text-sm text-slate-600 space-y-2">
          ...
          <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-4">
            <p className="text-sm text-emerald-800">
              <strong>💡 {tr("chTip")}:</strong> Complete your profile and upload a resume to enable recruiter discovery. Higher profile completeness increases match scores with job opportunities.
            </p>
          </div>
        </CardContent>
      </Card>

    ...
    <div className="space-y-0 divide-y divide-gray-100">
      ...
      <div className="flex flex-col md:flex-row gap-6 md:gap-10 pb-8">
        <div className="md:w-56 flex-shrink-0">
          <h2 className="text-base font-bold text-gray-900">{tr("stAccountDetails")}</h2>
          <p className="text-sm text-gray-500 mt-1 leading-relaxed">Your users will use this information to contact you.</p>
        </div>
        <div className="flex-1 space-y-4">
          <div className="space-y-2">
            <label className="text-sm font-semibold text-gray-700">{tr("fullNameLabel")} <span className="text-red-500">*</span></label>
      ...
      <div className="flex flex-col md:flex-row gap-6 md:gap-10 pt-8">
        <div className="md:w-56 flex-shrink-0">
          <h2 className="text-base font-bold text-gray-900">{tr("stAddress")}</h2>
          <p className="text-sm text-gray-500 mt-1 leading-relaxed">This address will appear on your invoice.</p>
        </div>
        <div className="flex-1 space-y-4">
          <div className="space-y-2">
            <label className="text-sm font-semibold text-gray-700">{tr("stAddressField")} <span className="text-red-500">*</span></label>
            <Input defaultValue="Apartment" className="border-gray-200 rounded-lg" />
          </div>
          <div className="space-y-2">
            <label className="text-sm font-semibold text-gray-700">{tr("stCountry")} <span className="text-red-500">*</span></label>
          ...
          <div className="space-y-2">
            <label className="text-sm font-semibold text-gray-700">{tr("stCity")} <span className="text-red-500">*</span></label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <label className="text-sm font-semibold text-gray-700">{tr("stPostalCode")} <span className="text-red-500">*</span></label>
